...
Payment result is based on **totalAmount**:
...
To create PENDING, need total amount ending with `.50`. Example: quantity = 2, price = 29.75 → total = 59.50
...
Mock profile uses **H2 in-memory database**.
